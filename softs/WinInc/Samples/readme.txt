 ...
 About JWlink: JWlink is a fork of Open Watcom's Wlink. To download JWlink see
 http://www.japheth.de/JWlink.html. If you want/need to use Wlink instead,
 be sure to add JWasm's -zzs switch to the assembly step. See the JWasm
 documentation for details about this commandline switch.
